export const DataScienceCourseData = [
  {
    ...
    ProgramInfo: {
      BatchDate: "16 December 2022",
      BatchDuration: "09 Months",
      Placement: "Guaranteed job referral",
    },
    BoxShape: {
      ...
      Box3h5: "Guaranteed job referral",
      box3desc:
        " Get Guaranteed job referral in top companies and startups. Also, receive guidance on resume building and interview.",
    ...
    Benefits: {
      desc: " Learn Data science with multiple domain specialization and become a data scientist with our Guaranteed job referral program.",
      ...
      JobT: "Guaranteed job referral",
      JobD: " Our program gives assured job referrals that can help you get placed in MNC's.",
    },
    Certificate: {
      popupHead: "Download Data science Brochure",
      title: "Get Certificate directly from AI companies",
      desc: "Get Guaranteed job referral and real-work experience by learning from the best data science institute in India and crack interviews with confidence.",
    },
    RealWork: {
      desc: "Our Advanced Data science and AI course with Guaranteed job referral follows a project-based learning approach. Further, it       focuses on helping learners build relevant experience in the technologies to land your super dream job.",
    },
    syllabusDesc:
      "Skillslash’s best Data Science course in Bangalore comes with a Guaranteed job referral. Besides, the Data Science and AI courses are curated by leading faculties and industry leaders. Especially, with the aim to provide practical data science learning experience with live interactive classes and projects.",
    ...
    syllabus: [
      ...
      {
        Module0: {
          title: "Module 6- Reinforcement Learning (only in Pro Max)",
          content: [
            {
              chap: {
                title: "",
      ...
      {
        Module0: {
          title: "Module 7- Computer Vision (only in Pro Max)",
          content: [
            {
              chap: {
                title: "",
    ...
    Fee: {
      ...
      BasicPrice: "₹ 59,999 + GST",
      BasicDesc: "3% cashback on creditcard payment",
      ProPrice: "₹ 109,999 + GST",
      ProDesc: "5% cashback on credit card payment",
      ProMaxPrice: "₹ 1,49,999 + GST",
      ProMaxDesc: "Guaranteed job referral",
    },
    BatchDates: [
      {
        batchDate: "26",
        ...
        batchTime: "09:00 to 12:00",
        batchDesc: "Limited seats are available",
        batchDescSpan: "Hurry!",
        batchWeek: "weekend batch (Sat - Sun)",
        batchMsg: "Seats are partially filled",
        activeBatch: true,
      },
      {
        batchDate: "16",
    ...
    FAQ: {
      desc: "Learn from experts in live-interactive classes under Advanced data science and AI course with Guaranteed job referral.",
    },
  },
];
